...
| 3  | `src/components/Breadcrumb.astro`        | `src/components/Breadcrumb.astro`                                                         | ✅ 已恢复 | 随 zh.ts 自动满足，无需单独改动                             |
...
| 7  | `src/pages/index.astro`                  | `src/pages/index.astro`                                                                    | ✅ 已恢复 | 恢复一言模块（hitokoto + localStorage 缓存 + 淡入动画）      |
...
- 动态 OG：❌ 已关闭，无恢复计划
- 迁移进度：P1 完成 → 继续 P2/P3（见 `docs/astro-paper-v6-p2-p3-restore-mapping.md`）

---

## 下一步

- 进入 P2/P3 恢复计划：`docs/astro-paper-v6-p2-p3-restore-mapping.md`
- 或直接推送分支并发起 PR
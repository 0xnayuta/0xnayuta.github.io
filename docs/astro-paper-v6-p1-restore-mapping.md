...
| 11  | `src/pages/og.png.ts`                    | `src/pages/og.png.ts`                                                                      | ✅ 已启用 | 正式版复核确认：dynamic OG 当前实际启用                             |
| 12  | `src/pages/posts/[...slug]/index.png.ts` | `src/pages/posts/[...slug]/index.png.ts`                                                   | ✅ 已启用 | 同上                                                                |
...
- 分支：`chore/astro-paper-v6-release-minimal-migration-doc`（正式版复核分支）
- 构建：✅ `pnpm format && pnpm lint && pnpm build` 通过
- 动态 OG：✅ 当前已启用（`src/pages/og.png.ts` 与 `src/pages/posts/[...slug]/index.png.ts`）
...
- 参考正式版复核记录：`docs/astro-paper-v6-release-recheck-report.md`
- 按 PR 流程提交文档对齐结果
